  ...
  return (
    <div className='m-10 text-lg space-y-3 bg-slate-500 rounded-lg shadow-lg bg-opacity-5 p-3'>
      <h1><strong>Return and Refund Policy</strong></h1>
        ...
        <ul>
        <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Edvisor.</p>
        </li>
        <li>
        ...
        <li>
        <p><strong>Website</strong> refers to Edvisor, accessible from <a href="edvisorapp.com" rel="external nofollow noopener" target="_blank">edvisorapp.com</a></p>
        </li>
        <li>
        ...
        <ul>
        <li>By email: edvisoruct@gmail.com</li>
        </ul>
        <p>We will reimburse You no later than 14 days from the day on which We receive the returned Goods. We will use the same means of payment as You used for the Order, and You will not incur any fees for such reimbursement.</p>
        <h1><strong>Conditions for Returns</strong></h1>
