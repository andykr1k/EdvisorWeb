  ...
  return (
    <div className='m-10 text-lg space-y-3 bg-slate-500 bg-opacity-5 rounded-lg shadow-lg p-3'>
      <h1><strong>Privacy Policy</strong></h1>
        ...
        <li>
        <p><strong>Website</strong> refers to Edvisor, accessible from <a href="www.edvisorapp.com" rel="external nofollow noopener" target="_blank">www.edvisorapp.com</a></p>
        </li>
        <li>
        ...
        <ul>
        <li>
        <p>By email: edvisoruct@gmail.com</p>
        </li>
        <li>
        <p>By visiting this page on our website: <a href="edvisor.netlify.app/contact" rel="external nofollow noopener" target="_blank">edvisor.netlify.app/contact</a></p>
        </li>
        </ul>
    </div>
  )
